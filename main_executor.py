...
if __name__ == '__main__':
    ...
    parser.add_argument('-train_root',
                        default="/vol3/schatter/DS6/Dataset/BiasFieldCorrected/300/test/vk04.nii",
                        help="Root folder for training")
    parser.add_argument('-test_root',
                        default="/vol3/schatter/DS6/Dataset/BiasFieldCorrected/300/test/vk04.nii",
                        help="Root folder for testing")
    parser.add_argument('-train_csv',
                        default="/vol3/schatter/DS6/Dataset/BiasFieldCorrected/300/test/vk04.nii",
                        help="Path to the train data csv file")
    parser.add_argument('-traincase_csv',
                        default="/vol3/schatter/DS6/Dataset/BiasFieldCorrected/300/test/vk04.nii",
                        help="Path to the train cases csv file")
    parser.add_argument('-test_csv',
                        default="/vol3/schatter/DS6/Dataset/BiasFieldCorrected/300/test/vk04.nii",
                        help="Path to the test data csv file")
    parser.add_argument('-testcase_csv',
                        default="/vol3/schatter/DS6/Dataset/BiasFieldCorrected/300/test/vk04.nii",
                        help="Path to the test cases csv file")
    parser.add_argument("-temperature",
                        type=float,
                        default=1.0,
                        help="temperature sharpening parameter")
    parser.add_argument("-segcor_weight",
                        type=float,
                        default=[1.0, 10.0],
                        nargs='+',
    ...
    # Model
    net1 = torch.nn.DataParallel(getModel(args.model, OUTPUT_PATH + "/" + MODEL_NAME))
    net1.cuda()
    net2 = torch.nn.DataParallel(getModel(args.model, OUTPUT_PATH + "/" + MODEL_NAME))
    net2.cuda()

    writer_training = SummaryWriter(TENSORBOARD_PATH_TRAINING)
    writer_validating = SummaryWriter(TENSORBOARD_PATH_VALIDATION)

    pipeline = Pipeline(cmd_args=args, net1=net1, net2=net2, logger=logger,
